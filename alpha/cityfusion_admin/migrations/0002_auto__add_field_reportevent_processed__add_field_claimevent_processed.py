...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportEvent.processed'
        db.add_column(u'cityfusion_admin_reportevent', 'processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ClaimEvent.processed'
        db.add_column(u'cityfusion_admin_claimevent', 'processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportEvent.processed'
        db.delete_column(u'cityfusion_admin_reportevent', 'processed')

        # Deleting field 'ClaimEvent.processed'
        db.delete_column(u'cityfusion_admin_claimevent', 'processed')
    ...
    models = {
        ...
        u'cityfusion_admin.reportevent': {
        ...
        u'event.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
    ...
    complete_apps = ['cityfusion_admin']