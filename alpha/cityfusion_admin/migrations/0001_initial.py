...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cityfusion_admin_reportevent', (
        ...
        db.send_create_signal(u'cityfusion_admin', ['ReportEvent'])

        # Adding model 'ClaimEvent'
        db.create_table(u'cityfusion_admin_claimevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Event'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
            ('message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'cityfusion_admin', ['ClaimEvent'])


    def backwards(self, orm):
        # Deleting model 'ReportEvent'
        db.delete_table(u'cityfusion_admin_reportevent')

        # Deleting model 'ClaimEvent'
        db.delete_table(u'cityfusion_admin_claimevent')
