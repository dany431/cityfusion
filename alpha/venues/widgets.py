...
class VenueTagAutoSuggest(forms.TextInput):
    input_type = 'text'
    ...
    def render(self, name, value, attrs=None):
        ...
        result_html = super(VenueTagAutoSuggest, self).render(name, value, result_attrs)

        widget_attrs = copy.copy(attrs)
        widget_attrs['id'] += '__tagautosuggest'
        widget_html = super(VenueTagAutoSuggest, self).render(name, value, widget_attrs)
