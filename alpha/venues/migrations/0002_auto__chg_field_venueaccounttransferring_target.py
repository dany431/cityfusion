...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VenueAccountTransferring.target'
        db.alter_column(u'venues_venueaccounttransferring', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account']))

    def backwards(self, orm):

        # Changing field 'VenueAccountTransferring.target'
        db.alter_column(u'venues_venueaccounttransferring', 'target_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
