...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VenueAccountTransferring'
        db.create_table(u'venues_venueaccounttransferring', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'venues', ['VenueAccountTransferring'])
    ...
    def backwards(self, orm):
        # Deleting model 'VenueAccountTransferring'
        db.delete_table(u'venues_venueaccounttransferring')
    ...
    models = {
        ...
        u'venues.venueaccounttransferring': {
            ...
            'venue_accounts': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.VenueAccount']", 'symmetrical': 'False'})
        }
    }
