...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VenueAccountTransferring.venue_account'
        db.add_column(u'venues_venueaccounttransferring', 'venue_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.VenueAccount']),
                      keep_default=False)

        # Removing M2M table for field venue_accounts on 'VenueAccountTransferring'
        db.delete_table(db.shorten_name(u'venues_venueaccounttransferring_venue_accounts'))


    def backwards(self, orm):
        # Deleting field 'VenueAccountTransferring.venue_account'
        db.delete_column(u'venues_venueaccounttransferring', 'venue_account_id')

        # Adding M2M table for field venue_accounts on 'VenueAccountTransferring'
        m2m_table_name = db.shorten_name(u'venues_venueaccounttransferring_venue_accounts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('venueaccounttransferring', models.ForeignKey(orm[u'venues.venueaccounttransferring'], null=False)),
            ('venueaccount', models.ForeignKey(orm[u'accounts.venueaccount'], null=False))
        ))
        db.create_unique(m2m_table_name, ['venueaccounttransferring_id', 'venueaccount_id'])
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'SINGLE'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'venues.venueaccounttransferring': {
            'Meta': {'object_name': 'VenueAccountTransferring'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Account']"}),
            'venue_account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.VenueAccount']"})
        }
    }
