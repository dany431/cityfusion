...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SingleEvent'
        db.create_table('event_singleevent', (
        ...
        db.send_create_signal('event', ['SingleEvent'])


    def backwards(self, orm):
        # Deleting model 'SingleEvent'
        db.delete_table('event_singleevent')
    ...
    models = {
        ...
        'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 22, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'location_name': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 22, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
