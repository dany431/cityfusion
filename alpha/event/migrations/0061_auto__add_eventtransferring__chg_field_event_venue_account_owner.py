...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventTransferring'
        db.create_table(u'event_eventtransferring', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'event', ['EventTransferring'])

        # Adding M2M table for field events on 'EventTransferring'
        db.create_table(u'event_eventtransferring_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventtransferring', models.ForeignKey(orm[u'event.eventtransferring'], null=False)),
            ('event', models.ForeignKey(orm[u'event.event'], null=False))
        ))
        db.create_unique(u'event_eventtransferring_events', ['eventtransferring_id', 'event_id'])

        # Changing field 'Event.venue_account_owner'
        db.alter_column(u'event_event', 'venue_account_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.VenueAccount'], null=True))


    def backwards(self, orm):
        
        # Deleting model 'EventTransferring'
        db.delete_table(u'event_eventtransferring')

        # Removing M2M table for field events on 'EventTransferring'
        db.delete_table('event_eventtransferring_events')

        # Changing field 'Event.venue_account_owner'
        db.alter_column(u'event_event', 'venue_account_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.VenueAccount'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 7, 53, 18, 934017)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 7, 53, 18, 932628)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 7, 53, 14, 536307)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 7, 53, 14, 536408)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'event.featuredeventorder': {
            ...
            'cost': ('djmoney.models.fields.MoneyField', [], {'default': "'0.0'", 'max_digits': '10', 'decimal_places': '2', 'default_currency': "'CAD'"}),
            'cost_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'CAD'", 'max_length': '3'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 26, 7, 53, 14, 562212)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'event.singleevent': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'occurrences': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['event.SingleEventOccurrence']", 'null': 'True', 'blank': 'True'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {})
        },
