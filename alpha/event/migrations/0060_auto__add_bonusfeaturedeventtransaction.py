...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BonusFeaturedEventTransaction'
        db.create_table(u'event_bonusfeaturedeventtransaction', (
            ...
            ('processed_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'event', ['BonusFeaturedEventTransaction'])


    def backwards(self, orm):
        # Deleting model 'BonusFeaturedEventTransaction'
        db.delete_table(u'event_bonusfeaturedeventtransaction')
    ...
    models = {
        ...
        u'event.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
