...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'event_featuredeventorder_taxes', (
            ...
            ('accounttaxcost', models.ForeignKey(orm[u'accounts.accounttaxcost'], null=False))
        ))
        db.create_unique(u'event_featuredeventorder_taxes', ['featuredeventorder_id', 'accounttaxcost_id'])
