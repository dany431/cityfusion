...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('event_event', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 14, 1, 0, 41, 771395), auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Event.modified'
        db.add_column('event_event', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 14, 1, 0, 41, 771447), auto_now=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('event_event', 'modified')
    ...
    models = {
        ...
        'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 14, 1, 0, 41, 771395)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'end_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 14, 1, 0, 41, 771447)', 'auto_now': 'True', 'blank': 'True'}),
