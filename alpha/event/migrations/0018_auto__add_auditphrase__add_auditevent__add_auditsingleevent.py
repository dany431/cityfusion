...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AuditPhrase'
        db.create_table(u'event_auditphrase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('phrase', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'event', ['AuditPhrase'])

        # Adding model 'AuditEvent'
        db.create_table(u'event_auditevent', (
            (u'event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['event.Event'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'event', ['AuditEvent'])

        # Adding M2M table for field phrases on 'AuditEvent'
        db.create_table(u'event_auditevent_phrases', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('auditevent', models.ForeignKey(orm[u'event.auditevent'], null=False)),
            ('auditphrase', models.ForeignKey(orm[u'event.auditphrase'], null=False))
        ))
        db.create_unique(u'event_auditevent_phrases', ['auditevent_id', 'auditphrase_id'])

        # Adding model 'AuditSingleEvent'
        db.create_table(u'event_auditsingleevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'event', ['AuditSingleEvent'])

        # Adding M2M table for field phrases on 'AuditSingleEvent'
        db.create_table(u'event_auditsingleevent_phrases', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('auditsingleevent', models.ForeignKey(orm[u'event.auditsingleevent'], null=False)),
            ('auditphrase', models.ForeignKey(orm[u'event.auditphrase'], null=False))
        ))
        db.create_unique(u'event_auditsingleevent_phrases', ['auditsingleevent_id', 'auditphrase_id'])


    def backwards(self, orm):
        # Deleting model 'AuditPhrase'
        db.delete_table(u'event_auditphrase')

        # Deleting model 'AuditEvent'
        db.delete_table(u'event_auditevent')

        # Removing M2M table for field phrases on 'AuditEvent'
        db.delete_table('event_auditevent_phrases')

        # Deleting model 'AuditSingleEvent'
        db.delete_table(u'event_auditsingleevent')

        # Removing M2M table for field phrases on 'AuditSingleEvent'
        db.delete_table('event_auditsingleevent_phrases')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
