...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedEvent.all_of_canada'
        db.add_column(u'event_featuredevent', 'all_of_canada',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding M2M table for field regions on 'FeaturedEvent'
        db.create_table(u'event_featuredevent_regions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('featuredevent', models.ForeignKey(orm[u'event.featuredevent'], null=False)),
            ('region', models.ForeignKey(orm[u'cities.region'], null=False))
        ))
        db.create_unique(u'event_featuredevent_regions', ['featuredevent_id', 'region_id'])


    def backwards(self, orm):
        # Deleting field 'FeaturedEvent.all_of_canada'
        db.delete_column(u'event_featuredevent', 'all_of_canada')

        # Removing M2M table for field regions on 'FeaturedEvent'
        db.delete_table('event_featuredevent_regions')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 3, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
