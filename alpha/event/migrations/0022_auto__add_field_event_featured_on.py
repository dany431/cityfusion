...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.featured_on'
        db.add_column(u'event_event', 'featured_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 6, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.featured_on'
        db.delete_column(u'event_event', 'featured_on')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'featured_on': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
