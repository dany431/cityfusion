...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedEvent.owner'
        db.add_column(u'event_featuredevent', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeaturedEvent.owner'
        db.delete_column(u'event_featuredevent', 'owner_id')
