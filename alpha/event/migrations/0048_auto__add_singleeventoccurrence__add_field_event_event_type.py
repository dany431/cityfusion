...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field occurrences on 'SingleEvent'
        db.create_table(u'event_singleevent_occurrences', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('singleevent', models.ForeignKey(orm[u'event.singleevent'], null=False)),
            ('singleeventoccurrence', models.ForeignKey(orm[u'event.singleeventoccurrence'], null=False))
        ))
        db.create_unique(u'event_singleevent_occurrences', ['singleevent_id', 'singleeventoccurrence_id'])

        # Adding field 'Event.event_type'
        db.add_column(u'event_event', 'event_type',
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field occurrences on 'SingleEvent'
        db.delete_table('event_singleevent_occurrences')

        # Deleting field 'Event.event_type'
        db.delete_column(u'event_event', 'event_type')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
