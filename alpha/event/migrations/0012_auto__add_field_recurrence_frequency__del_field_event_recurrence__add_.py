...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recurrence.frequency'
        db.add_column('event_recurrence', 'frequency', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Event.recurrence'
        db.delete_column('event_event', 'recurrence_id')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Recurrence.frequency'
        db.delete_column('event_recurrence', 'frequency')

        # Adding field 'Event.recurrence'
        db.add_column('event_event', 'recurrence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Recurrence'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 25, 12, 5, 50, 456693)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 25, 12, 5, 50, 456757)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'price': ('django.db.models.fields.CharField', [], {'default': "'Free'", 'max_length': '40', 'blank': 'True'}),
            'recur': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
