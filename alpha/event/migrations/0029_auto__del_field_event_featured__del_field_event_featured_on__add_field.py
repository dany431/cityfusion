...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'event_event', 'featured')

        # Deleting field 'Event.featured_on'
        db.delete_column(u'event_event', 'featured_on')

        # Adding field 'FeaturedEvent.active'
        db.add_column(u'event_featuredevent', 'active',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'event_event', 'featured',
        ...
        # Deleting field 'FeaturedEvent.active'
        db.delete_column(u'event_featuredevent', 'active')
