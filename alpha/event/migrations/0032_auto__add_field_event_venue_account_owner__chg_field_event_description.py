...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.venue_account_owner'
        db.add_column(u'event_event', 'venue_account_owner',
        ...
        db.alter_column(u'event_event', 'description', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):
        # Deleting field 'Event.venue_account_owner'
        db.delete_column(u'event_event', 'venue_account_owner_id')


        # Changing field 'Event.description'
        db.alter_column(u'event_event', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
