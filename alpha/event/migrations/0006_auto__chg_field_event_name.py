...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event_event', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))


    def backwards(self, orm):
        
        # Changing field 'Event.name'
        db.alter_column('event_event', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
