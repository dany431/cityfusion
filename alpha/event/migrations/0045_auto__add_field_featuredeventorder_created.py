...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedEventOrder.created'
        db.add_column(u'event_featuredeventorder', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 5, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field taxes on 'FeaturedEventOrder'
        db.create_table(u'event_featuredeventorder_taxes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('featuredeventorder', models.ForeignKey(orm[u'event.featuredeventorder'], null=False)),
            ('accounttax', models.ForeignKey(orm[u'accounts.accounttax'], null=False))
        ))
        db.create_unique(u'event_featuredeventorder_taxes', ['featuredeventorder_id', 'accounttax_id'])


    def backwards(self, orm):
        # Deleting field 'FeaturedEventOrder.created'
        db.delete_column(u'event_featuredeventorder', 'created')

        # Removing M2M table for field taxes on 'FeaturedEventOrder'
        db.delete_table('event_featuredeventorder_taxes')
