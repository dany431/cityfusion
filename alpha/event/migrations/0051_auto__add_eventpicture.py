...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventPicture'
        db.create_table(u'event_eventpicture', (
        ...
        db.send_create_signal(u'event', ['EventPicture'])


    def backwards(self, orm):
        # Deleting model 'EventPicture'
        db.delete_table(u'event_eventpicture')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'event.eventpicture': {
            'Meta': {'object_name': 'EventPicture'},
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['event.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
