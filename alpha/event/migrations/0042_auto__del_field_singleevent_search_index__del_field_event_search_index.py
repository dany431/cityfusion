...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SingleEvent.search_index'
        db.delete_column(u'event_singleevent', 'search_index')

        # Deleting field 'Event.search_index'
        db.delete_column(u'event_event', 'search_index')


    def backwards(self, orm):
        # Adding field 'SingleEvent.search_index'
        db.add_column(u'event_singleevent', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Event.search_index'
        db.add_column(u'event_event', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)
