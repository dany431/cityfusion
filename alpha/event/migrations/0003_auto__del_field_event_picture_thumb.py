...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.picture_thumb'
        db.delete_column('event_event', 'picture_thumb')


    def backwards(self, orm):
        
        # Adding field 'Event.picture_thumb'
        db.add_column('event_event', 'picture_thumb', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
