...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.viewed_times'
        db.alter_column(u'event_event', 'viewed_times', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.viewed_times'
        db.alter_column(u'event_event', 'viewed_times', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 17, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'viewed_times': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
