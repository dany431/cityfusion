...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventImage.main'
        db.delete_column(u'event_eventimage', 'main')

        # Adding field 'EventImage.order'
        db.add_column(u'event_eventimage', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventImage.main'
        db.add_column(u'event_eventimage', 'main',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'EventImage.order'
        db.delete_column(u'event_eventimage', 'order')
