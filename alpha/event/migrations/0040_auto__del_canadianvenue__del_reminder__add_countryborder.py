...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'event_canadianvenue')

        # Deleting model 'Reminder'
        db.delete_table(u'event_reminder')

        # Adding model 'CountryBorder'
        db.create_table(u'event_countryborder', (
        ...
        db.send_create_signal(u'event', ['CountryBorder'])


    def backwards(self, orm):
        # Adding model 'CanadianVenue'
        db.create_table(u'event_canadianvenue', (
        ...
        db.send_create_signal(u'event', ['CanadianVenue'])

        # Adding model 'Reminder'
        db.create_table(u'event_reminder', (
        ...
        db.send_create_signal(u'event', ['Reminder'])

        # Deleting model 'CountryBorder'
        db.delete_table(u'event_countryborder')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
