...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SingleEventOccurrence'
        db.delete_table(u'event_singleeventoccurrence')

        # Adding field 'SingleEvent.viewed'
        db.add_column(u'event_singleevent', 'viewed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Event.viewed_times'
        db.delete_column(u'event_event', 'viewed_times')
    ...
    def backwards(self, orm):
        # Adding model 'SingleEventOccurrence'
        db.create_table(u'event_singleeventoccurrence', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'event', ['SingleEventOccurrence'])

        # Deleting field 'SingleEvent.viewed'
        db.delete_column(u'event_singleevent', 'viewed')

        # Adding field 'Event.viewed_times'
        db.add_column(u'event_event', 'viewed_times',
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'SINGLE'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
