...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event_event', 'venue_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Venue'], null=True))

    def backwards(self, orm):
        # Adding field 'Event.location_name'
        db.add_column('event_event', 'location_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


        # Changing field 'Event.venue'
        db.alter_column('event_event', 'venue_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.CanadianVenue'], null=True))
