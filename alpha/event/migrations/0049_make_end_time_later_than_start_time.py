...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        SingleEventOccurrence = orm['event.SingleEventOccurrence']
        
        SingleEvent.objects.filter(end_time__lt=F('start_time')).update(end_time=F('end_time')+datetime.timedelta(days=1))
        SingleEventOccurrence.objects.filter(end_time__lt=F('start_time')).update(end_time=F('end_time')+datetime.timedelta(days=1))
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
