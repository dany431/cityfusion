...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SingleEvent.facebook_event'
        db.add_column(u'event_singleevent', 'facebook_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.FacebookEvent'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'SingleEvent.facebook_event'
        db.delete_column(u'event_singleevent', 'facebook_event_id')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 13, 0, 31, 873818)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 13, 0, 31, 872418)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 13, 0, 30, 419221)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 13, 0, 30, 419296)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'event.featuredeventorder': {
            ...
            'cost': ('djmoney.models.fields.MoneyField', [], {'default': "'0.0'", 'max_digits': '10', 'decimal_places': '2', 'default_currency': "'CAD'"}),
            'cost_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'CAD'", 'max_length': '3'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 13, 0, 30, 440326)', 'auto_now_add': 'True', 'blank': 'True'}),
            'featured_event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['event.FeaturedEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
