...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedEvent.venue_account'
        db.add_column(u'event_featuredevent', 'venue_account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.VenueAccount'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeaturedEvent.venue_account'
        db.delete_column(u'event_featuredevent', 'venue_account_id')
    ...
    models = {
        u'accounts.account': {
            ...
            'in_the_loop_phonenumber': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True', 'null': 'True'}),
            ...
            'reminder_phonenumber': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True', 'null': 'True'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
