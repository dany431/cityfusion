...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.comment_for_facebook'
        db.delete_column(u'event_event', 'comment_for_facebook')

        # Deleting field 'Event.facebook_event'
        db.delete_column(u'event_event', 'facebook_event_id')

        # Deleting field 'Event.post_to_facebook'
        db.delete_column(u'event_event', 'post_to_facebook')


    def backwards(self, orm):
        
        # Adding field 'Event.comment_for_facebook'
        db.add_column(u'event_event', 'comment_for_facebook', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Event.facebook_event'
        db.add_column(u'event_event', 'facebook_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.FacebookEvent'], null=True, blank=True), keep_default=False)

        # Adding field 'Event.post_to_facebook'
        db.add_column(u'event_event', 'post_to_facebook', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 51, 37, 280035)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 51, 37, 278755)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 51, 36, 76740)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'SINGLE'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 51, 36, 76827)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'event.featuredeventorder': {
            ...
            'cost': ('djmoney.models.fields.MoneyField', [], {'default': "'0.0'", 'max_digits': '10', 'decimal_places': '2', 'default_currency': "'CAD'"}),
            'cost_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'CAD'", 'max_length': '3'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 14, 51, 36, 97488)', 'auto_now_add': 'True', 'blank': 'True'}),
            'featured_event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['event.FeaturedEvent']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
