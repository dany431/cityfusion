...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('event_event', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.website'
        db.delete_column('event_event', 'website')
