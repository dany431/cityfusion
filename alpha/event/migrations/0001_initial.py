...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('event_event', (
            ...
            ('authentication_key', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, db_index=True)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('picture_thumb', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ...
            ('venue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.CanadianVenue'], null=True, blank=True)),
            ('price', self.gf('django.db.models.fields.CharField')(default='Free', max_length=40, blank=True)),
        ))
        db.send_create_signal('event', ['Event'])

        # Adding model 'Venue'
        db.create_table('event_venue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('event', ['Venue'])

        # Adding model 'CanadianVenue'
        db.create_table('event_canadianvenue', (
            ('venue_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['event.Venue'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('event', ['CanadianVenue'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('event_venue')

        # Deleting model 'CanadianVenue'
        db.delete_table('event_canadianvenue')
    ...
    models = {
        ...
        'event.event': {
            ...
            'picture_thumb': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
