...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FeaturedEventOrder'
        db.create_table(u'event_featuredeventorder', (
            ...
            ('total_price_currency', self.gf('djmoney.models.fields.CurrencyField')(default='CAD', max_length=3)),
            ('total_price', self.gf('djmoney.models.fields.MoneyField')(default='0.0', max_digits=10, decimal_places=2, default_currency='CAD')),
            ('featured_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.FeaturedEvent'])),
        ...
        db.send_create_signal(u'event', ['FeaturedEventOrder'])


    def backwards(self, orm):
        # Deleting model 'FeaturedEventOrder'
        db.delete_table(u'event_featuredeventorder')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
