...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ShareAdvertisingCampaign'
        db.create_table(u'advertising_shareadvertisingcampaign', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advertising.AdvertisingCampaign'])),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
        ))
        db.send_create_signal(u'advertising', ['ShareAdvertisingCampaign'])

        # Changing field 'AdvertisingCampaign.venue_account'
        db.alter_column(u'advertising_advertisingcampaign', 'venue_account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.VenueAccount'], null=True))


    def backwards(self, orm):
        
        # Deleting model 'ShareAdvertisingCampaign'
        db.delete_table(u'advertising_shareadvertisingcampaign')

        # Changing field 'AdvertisingCampaign.venue_account'
        db.alter_column(u'advertising_advertisingcampaign', 'venue_account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.VenueAccount'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        u'accounts.account': {
            ...
            'money': ('djmoney.models.fields.MoneyField', [], {'default': "'0.0'", 'max_digits': '10', 'decimal_places': '2', 'default_currency': "'CAD'"}),
            'money_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'CAD'", 'max_length': '3'}),
        ...
        u'advertising.advertisingcampaign': {
            ...
            'venue_account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.VenueAccount']", 'null': 'True', 'blank': 'True'}),
        ...
        u'advertising.advertisingorder': {
            ...
            'budget_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'CAD'", 'max_length': '3'}),
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['advertising.AdvertisingCampaign']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 26, 17, 47, 38, 732858)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 26, 17, 47, 39, 495365)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 26, 17, 47, 39, 494811)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 26, 17, 47, 38, 694113)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 26, 17, 47, 38, 694215)', 'auto_now': 'True', 'blank': 'True'}),
