...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvertisingOrder.total_price_currency'
        db.add_column(u'advertising_advertisingorder', 'total_price_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='CAD', max_length=3),
                      keep_default=False)

        # Adding field 'AdvertisingOrder.total_price'
        db.add_column(u'advertising_advertisingorder', 'total_price',
                      self.gf('djmoney.models.fields.MoneyField')(default='0.0', max_digits=10, decimal_places=2, default_currency='CAD'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdvertisingOrder.total_price_currency'
        db.delete_column(u'advertising_advertisingorder', 'total_price_currency')

        # Deleting field 'AdvertisingOrder.total_price'
        db.delete_column(u'advertising_advertisingorder', 'total_price')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
