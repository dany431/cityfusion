...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advertising.review_status'
        db.add_column(u'advertising_advertising', 'review_status',
                      self.gf('django.db.models.fields.CharField')(default='PENDING', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advertising.review_status'
        db.delete_column(u'advertising_advertising', 'review_status')
