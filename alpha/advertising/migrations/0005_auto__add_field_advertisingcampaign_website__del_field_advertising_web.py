...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvertisingCampaign.website'
        db.add_column(u'advertising_advertisingcampaign', 'website',
                      self.gf('django.db.models.fields.URLField')(default='http://cityfusion.ca', max_length=200),
                      keep_default=False)

        # Deleting field 'Advertising.website'
        db.delete_column(u'advertising_advertising', 'website')


    def backwards(self, orm):
        # Deleting field 'AdvertisingCampaign.website'
        db.delete_column(u'advertising_advertisingcampaign', 'website')

        # Adding field 'Advertising.website'
        db.add_column(u'advertising_advertising', 'website',
                      self.gf('django.db.models.fields.URLField')(default='http://cityfusion.ca', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 2, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
