...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdvertisingCampaign.started'
        db.alter_column(u'advertising_advertisingcampaign', 'started', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
        # Deleting field 'Advertising.ad_company'
        db.delete_column(u'advertising_advertising', 'ad_company_id')

        # Deleting field 'Advertising.ads_image'
        db.delete_column(u'advertising_advertising', 'ads_image')

        # Adding field 'Advertising.campaign'
        db.add_column(u'advertising_advertising', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['advertising.AdvertisingCampaign']),
                      keep_default=False)

        # Adding field 'Advertising.image'
        db.add_column(u'advertising_advertising', 'image',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AdvertisingCampaign.started'
        db.alter_column(u'advertising_advertisingcampaign', 'started', self.gf('django.db.models.fields.DateTimeField')())

        # User chose to not deal with backwards NULL issues for 'Advertising.ad_company'
        raise RuntimeError("Cannot reverse this migration. 'Advertising.ad_company' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Advertising.ads_image'
        raise RuntimeError("Cannot reverse this migration. 'Advertising.ads_image' and its values cannot be restored.")
        # Deleting field 'Advertising.campaign'
        db.delete_column(u'advertising_advertising', 'campaign_id')

        # Deleting field 'Advertising.image'
        db.delete_column(u'advertising_advertising', 'image')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
