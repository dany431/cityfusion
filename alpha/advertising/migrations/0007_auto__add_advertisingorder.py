...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdvertisingOrder'
        db.create_table(u'advertising_advertisingorder', (
        ...
        db.send_create_signal(u'advertising', ['AdvertisingOrder'])


    def backwards(self, orm):
        # Deleting model 'AdvertisingOrder'
        db.delete_table(u'advertising_advertisingorder')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 24, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
