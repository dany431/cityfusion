...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AdvertisingCampaign.owned_by_admin'
        db.delete_column(u'advertising_advertisingcampaign', 'owned_by_admin')

        # Adding field 'AdvertisingCampaign.free'
        db.add_column(u'advertising_advertisingcampaign', 'free',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AdvertisingCampaign.owned_by_admin'
        db.add_column(u'advertising_advertisingcampaign', 'owned_by_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AdvertisingCampaign.free'
        db.delete_column(u'advertising_advertisingcampaign', 'free')
