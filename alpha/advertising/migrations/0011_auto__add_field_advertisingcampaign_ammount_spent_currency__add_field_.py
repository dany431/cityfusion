...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvertisingCampaign.ammount_spent_currency'
        db.add_column(u'advertising_advertisingcampaign', 'ammount_spent_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='CAD', max_length=3),
                      keep_default=False)

        # Adding field 'AdvertisingCampaign.ammount_spent'
        db.add_column(u'advertising_advertisingcampaign', 'ammount_spent',
                      self.gf('djmoney.models.fields.MoneyField')(default='0.0', max_digits=10, decimal_places=10, default_currency='CAD'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdvertisingCampaign.ammount_spent_currency'
        db.delete_column(u'advertising_advertisingcampaign', 'ammount_spent_currency')

        # Deleting field 'AdvertisingCampaign.ammount_spent'
        db.delete_column(u'advertising_advertisingcampaign', 'ammount_spent')
    ...
    models = {
        ...
        u'advertising.advertisingcampaign': {
            ...
            'ammount_spent': ('djmoney.models.fields.MoneyField', [], {'default': "'0.0'", 'max_digits': '10', 'decimal_places': '10', 'default_currency': "'CAD'"}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 25, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
