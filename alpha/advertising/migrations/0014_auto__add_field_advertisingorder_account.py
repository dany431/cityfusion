...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvertisingOrder.account'
        db.add_column(u'advertising_advertisingorder', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdvertisingOrder.account'
        db.delete_column(u'advertising_advertisingorder', 'account_id')
