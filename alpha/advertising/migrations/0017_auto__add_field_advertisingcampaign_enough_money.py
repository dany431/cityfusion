...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdvertisingCampaign.enough_money'
        db.add_column(u'advertising_advertisingcampaign', 'enough_money',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdvertisingCampaign.enough_money'
        db.delete_column(u'advertising_advertisingcampaign', 'enough_money')
    ...
    models = {
        ...
        u'event.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
