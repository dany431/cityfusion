...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdvertisingCampaign.ammount_spent'
        db.alter_column(u'advertising_advertisingcampaign', 'ammount_spent', self.gf('djmoney.models.fields.MoneyField')(max_digits=18, decimal_places=10, default_currency='CAD'))

    def backwards(self, orm):

        # Changing field 'AdvertisingCampaign.ammount_spent'
        db.alter_column(u'advertising_advertisingcampaign', 'ammount_spent', self.gf('djmoney.models.fields.MoneyField')(max_digits=10, decimal_places=10, default_currency='CAD'))
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 3, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
