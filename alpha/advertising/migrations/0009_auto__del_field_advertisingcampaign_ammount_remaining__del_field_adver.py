...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AdvertisingCampaign.ammount_remaining'
        db.delete_column(u'advertising_advertisingcampaign', 'ammount_remaining')

        # Deleting field 'AdvertisingCampaign.ammount_remaining_currency'
        db.delete_column(u'advertising_advertisingcampaign', 'ammount_remaining_currency')


    def backwards(self, orm):
        # Adding field 'AdvertisingCampaign.ammount_remaining'
        db.add_column(u'advertising_advertisingcampaign', 'ammount_remaining',
                      self.gf('djmoney.models.fields.MoneyField')(default='0.0', max_digits=10, decimal_places=2, default_currency='CAD'),
                      keep_default=False)

        # Adding field 'AdvertisingCampaign.ammount_remaining_currency'
        db.add_column(u'advertising_advertisingcampaign', 'ammount_remaining_currency',
