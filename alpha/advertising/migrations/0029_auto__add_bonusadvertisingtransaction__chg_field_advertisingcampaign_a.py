...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BonusAdvertisingTransaction'
        db.create_table(u'advertising_bonusadvertisingtransaction', (
        ...
        db.send_create_signal(u'advertising', ['BonusAdvertisingTransaction'])


    def backwards(self, orm):
        # Deleting model 'BonusAdvertisingTransaction'
        db.delete_table(u'advertising_bonusadvertisingtransaction')
