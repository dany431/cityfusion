...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdvertisingCampaign.venue_account'
        db.add_column(u'advertising_advertisingcampaign', 'venue_account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.VenueAccount'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdvertisingCampaign.venue_account'
        db.delete_column(u'advertising_advertisingcampaign', 'venue_account_id')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 12, 1, 33, 481024)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 12, 1, 33, 479657)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 12, 1, 32, 300213)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 26, 12, 1, 32, 300312)', 'auto_now': 'True', 'blank': 'True'}),
