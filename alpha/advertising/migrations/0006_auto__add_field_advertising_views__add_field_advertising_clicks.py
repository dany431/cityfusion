...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advertising.views'
        db.add_column(u'advertising_advertising', 'views',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Advertising.clicks'
        db.add_column(u'advertising_advertising', 'clicks',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advertising.views'
        db.delete_column(u'advertising_advertising', 'views')

        # Deleting field 'Advertising.clicks'
        db.delete_column(u'advertising_advertising', 'clicks')
