...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BonusAdvertisingTransaction.processed_at'
        db.add_column(u'advertising_bonusadvertisingtransaction', 'processed_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BonusAdvertisingTransaction.processed_at'
        db.delete_column(u'advertising_bonusadvertisingtransaction', 'processed_at')
