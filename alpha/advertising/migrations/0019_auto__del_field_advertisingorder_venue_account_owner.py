...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AdvertisingOrder.venue_account_owner'
        db.delete_column(u'advertising_advertisingorder', 'venue_account_owner_id')


    def backwards(self, orm):
        # Adding field 'AdvertisingOrder.venue_account_owner'
        db.add_column(u'advertising_advertisingorder', 'venue_account_owner',
