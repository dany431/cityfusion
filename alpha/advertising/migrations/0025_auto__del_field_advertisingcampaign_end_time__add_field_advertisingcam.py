...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AdvertisingCampaign.end_time'
        db.delete_column(u'advertising_advertisingcampaign', 'end_time')

        # Adding field 'AdvertisingCampaign.active_to'
        db.add_column(u'advertising_advertisingcampaign', 'active_to',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AdvertisingCampaign.end_time'
        db.add_column(u'advertising_advertisingcampaign', 'end_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'AdvertisingCampaign.active_to'
        db.delete_column(u'advertising_advertisingcampaign', 'active_to')
