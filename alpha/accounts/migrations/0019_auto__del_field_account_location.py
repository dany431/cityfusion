...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.location'
        db.delete_column(u'accounts_account', 'location')


    def backwards(self, orm):
        # Adding field 'Account.location'
        db.add_column(u'accounts_account', 'location',
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 7, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
