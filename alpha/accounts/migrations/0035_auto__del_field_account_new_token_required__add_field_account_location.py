...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.location_type'
        db.add_column(u'accounts_account', 'location_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.location_id'
        db.add_column(u'accounts_account', 'location_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.location_type'
        db.delete_column(u'accounts_account', 'location_type')

        # Deleting field 'Account.location_id'
        db.delete_column(u'accounts_account', 'location_id')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 31, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
