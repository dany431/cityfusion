...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.location_name'
        db.add_column(u'accounts_account', 'location_name',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.location_name'
        db.delete_column(u'accounts_account', 'location_name')
