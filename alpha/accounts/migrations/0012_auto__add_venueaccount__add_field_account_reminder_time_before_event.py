...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VenueAccount'
        db.create_table(u'accounts_venueaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('venue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Venue'])),
            ...
            ('about', self.gf('django.db.models.fields.TextField')(default='Not provided', null=True, blank=True)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('cropping', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'accounts', ['VenueAccount'])

        # Adding M2M table for field account on 'VenueAccount'
        db.create_table(u'accounts_venueaccount_account', (
        ...
        db.create_unique(u'accounts_venueaccount_account', ['venueaccount_id', 'account_id'])
    ...
    def backwards(self, orm):
        # Deleting model 'VenueAccount'
        db.delete_table(u'accounts_venueaccount')

        # Removing M2M table for field account on 'VenueAccount'
        db.delete_table('accounts_venueaccount_account')
    ...
    models = {
        ...
        u'accounts.venueaccount': {
            ...
            'about': ('django.db.models.fields.TextField', [], {'default': "'Not provided'", 'null': 'True', 'blank': 'True'}),
            'account': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.Account']", 'symmetrical': 'False'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
