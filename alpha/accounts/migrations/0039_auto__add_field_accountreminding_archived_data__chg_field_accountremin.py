...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountReminding.archived_data'
        db.add_column(u'accounts_accountreminding', 'archived_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'AccountReminding.single_event'
        db.alter_column(u'accounts_accountreminding', 'single_event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.SingleEvent'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AccountReminding.archived_data'
        db.delete_column(u'accounts_accountreminding', 'archived_data')

        # Changing field 'AccountReminding.single_event'
        db.alter_column(u'accounts_accountreminding', 'single_event_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['event.SingleEvent']))
    ...
    models = {
        ...
        u'accounts.accountreminding': {
            ...
            'archived_data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'single_event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['event.SingleEvent']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 6, 12, 54, 21, 146310)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 6, 12, 54, 21, 143907)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 6, 12, 54, 8, 252528)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 6, 12, 54, 8, 252615)', 'auto_now': 'True', 'blank': 'True'}),
