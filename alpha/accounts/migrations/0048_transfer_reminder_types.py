...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for account in accounts:
            account.reminder_type_state = REMINDER_TYPES[account.reminder_active_type]['id']
            account.save(update_fields=['reminder_type_state'])
            print '%s => %s' % (account.reminder_active_type, REMINDER_TYPES[account.reminder_active_type]['id'])

    def backwards(self, orm):
        Account = orm['accounts.Account']
        accounts = Account.objects.all()
        for account in accounts:
            account.reminder_type_state = REMINDER_TYPES['HOURS']['id']
            account.save(update_fields=['reminder_type_state'])
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'SINGLE'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
