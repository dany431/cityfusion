...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.not_from_canada'
        db.add_column(u'accounts_account', 'not_from_canada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.not_from_canada'
        db.delete_column(u'accounts_account', 'not_from_canada')
