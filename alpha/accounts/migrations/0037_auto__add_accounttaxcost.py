...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountTaxCost'
        db.create_table(u'accounts_accounttaxcost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_tax', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.AccountTax'])),
        ...
        db.send_create_signal(u'accounts', ['AccountTaxCost'])


    def backwards(self, orm):
        # Deleting model 'AccountTaxCost'
        db.delete_table(u'accounts_accounttaxcost')
