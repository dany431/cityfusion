...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VenueAccount.myspace'
        db.add_column(u'accounts_venueaccount', 'myspace',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'VenueAccount.phone'
        db.alter_column(u'accounts_venueaccount', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Account.reminder_phonenumber'
        db.alter_column(u'accounts_account', 'reminder_phonenumber', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Account.in_the_loop_phonenumber'
        db.alter_column(u'accounts_account', 'in_the_loop_phonenumber', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):
        # Deleting field 'VenueAccount.myspace'
        db.delete_column(u'accounts_venueaccount', 'myspace')


        # Changing field 'VenueAccount.phone'
        db.alter_column(u'accounts_venueaccount', 'phone', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True))

        # Changing field 'Account.reminder_phonenumber'
        db.alter_column(u'accounts_account', 'reminder_phonenumber', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True))

        # Changing field 'Account.in_the_loop_phonenumber'
        db.alter_column(u'accounts_account', 'in_the_loop_phonenumber', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True))
    ...
    models = {
        ...
        u'event.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 25, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
