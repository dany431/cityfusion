...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountTax'
        db.create_table(u'accounts_accounttax', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('all_of_canada', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('procents', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal(u'accounts', ['AccountTax'])

        # Adding M2M table for field regions on 'AccountTax'
        db.create_table(u'accounts_accounttax_regions', (
        ...
        db.create_unique(u'accounts_accounttax_regions', ['accounttax_id', 'region_id'])


    def backwards(self, orm):
        # Deleting model 'AccountTax'
        db.delete_table(u'accounts_accounttax')

        # Removing M2M table for field regions on 'AccountTax'
        db.delete_table('accounts_accounttax_regions')
