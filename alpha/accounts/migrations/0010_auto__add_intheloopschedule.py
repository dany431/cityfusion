...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InTheLoopSchedule'
        db.create_table(u'accounts_intheloopschedule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Event'])),
            ('processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'accounts', ['InTheLoopSchedule'])


    def backwards(self, orm):
        # Deleting model 'InTheLoopSchedule'
        db.delete_table(u'accounts_intheloopschedule')
