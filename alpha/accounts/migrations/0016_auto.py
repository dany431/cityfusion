...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field types on 'VenueAccount'
        db.create_table(u'accounts_venueaccount_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('venueaccount', models.ForeignKey(orm[u'accounts.venueaccount'], null=False)),
            ('venuetype', models.ForeignKey(orm[u'accounts.venuetype'], null=False))
        ))
        db.create_unique(u'accounts_venueaccount_types', ['venueaccount_id', 'venuetype_id'])


    def backwards(self, orm):
        # Removing M2M table for field types on 'VenueAccount'
        db.delete_table('accounts_venueaccount_types')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
