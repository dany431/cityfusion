...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_account', 'about_me',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.facebook_id'
        db.add_column(u'accounts_account', 'facebook_id',
                      self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.access_token'
        db.add_column(u'accounts_account', 'access_token',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.facebook_name'
        db.add_column(u'accounts_account', 'facebook_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.facebook_profile_url'
        db.add_column(u'accounts_account', 'facebook_profile_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.website_url'
        db.add_column(u'accounts_account', 'website_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.blog_url'
        db.add_column(u'accounts_account', 'blog_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.date_of_birth'
        db.add_column(u'accounts_account', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.gender'
        db.add_column(u'accounts_account', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.raw_data'
        db.add_column(u'accounts_account', 'raw_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.facebook_open_graph'
        db.add_column(u'accounts_account', 'facebook_open_graph',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'accounts_account', 'about_me')

        # Deleting field 'Account.facebook_id'
        db.delete_column(u'accounts_account', 'facebook_id')

        # Deleting field 'Account.access_token'
        db.delete_column(u'accounts_account', 'access_token')

        # Deleting field 'Account.facebook_name'
        db.delete_column(u'accounts_account', 'facebook_name')

        # Deleting field 'Account.facebook_profile_url'
        db.delete_column(u'accounts_account', 'facebook_profile_url')

        # Deleting field 'Account.website_url'
        db.delete_column(u'accounts_account', 'website_url')

        # Deleting field 'Account.blog_url'
        db.delete_column(u'accounts_account', 'blog_url')

        # Deleting field 'Account.date_of_birth'
        db.delete_column(u'accounts_account', 'date_of_birth')

        # Deleting field 'Account.gender'
        db.delete_column(u'accounts_account', 'gender')

        # Deleting field 'Account.raw_data'
        db.delete_column(u'accounts_account', 'raw_data')

        # Deleting field 'Account.facebook_open_graph'
        db.delete_column(u'accounts_account', 'facebook_open_graph')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 7, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
