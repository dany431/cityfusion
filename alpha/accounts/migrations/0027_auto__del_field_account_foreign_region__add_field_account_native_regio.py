...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.foreign_region'
        db.delete_column(u'accounts_account', 'foreign_region_id')

        # Adding field 'Account.native_region'
        db.add_column(u'accounts_account', 'native_region',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='native_for_accounts', null=True, to=orm['cities.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Account.foreign_region'
        db.add_column(u'accounts_account', 'foreign_region',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='foreign_for_accounts', null=True, to=orm['cities.Region'], blank=True),
                      keep_default=False)

        # Deleting field 'Account.native_region'
        db.delete_column(u'accounts_account', 'native_region_id')
