...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AccountReminding.event'
        db.delete_column(u'accounts_accountreminding', 'event_id')

        # Adding field 'AccountReminding.single_event'
        db.add_column(u'accounts_accountreminding', 'single_event', self.gf('django.db.models.fields.related.ForeignKey')(null=True,to=orm['event.SingleEvent']), keep_default=False)

        # Removing M2M table for field reminder_events on 'Account'
        db.delete_table('accounts_account_reminder_events')

        # Adding M2M table for field reminder_single_events on 'Account'
        db.create_table(u'accounts_account_reminder_single_events', (
        ...
        db.create_unique(u'accounts_account_reminder_single_events', ['account_id', 'singleevent_id'])
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'AccountReminding.event'
        raise RuntimeError("Cannot reverse this migration. 'AccountReminding.event' and its values cannot be restored.")

        # Deleting field 'AccountReminding.single_event'
        db.delete_column(u'accounts_accountreminding', 'single_event_id')
        ...
        db.create_unique(u'accounts_account_reminder_events', ['account_id', 'event_id'])

        # Removing M2M table for field reminder_single_events on 'Account'
        db.delete_table('accounts_account_reminder_single_events')
    ...
    models = {
        ...
        u'accounts.accountreminding': {
            ...
            'single_event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['event.SingleEvent']"})
        },
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 1, 50, 26, 380759)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 1, 50, 26, 379373)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 1, 46, 13, 394961)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 1, 46, 13, 395041)', 'auto_now': 'True', 'blank': 'True'}),
