...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BonusCampaign.apply_to_old_accounts'
        db.add_column(u'accounts_bonuscampaign', 'apply_to_old_accounts',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BonusCampaign.apply_to_old_accounts'
        db.delete_column(u'accounts_bonuscampaign', 'apply_to_old_accounts')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
