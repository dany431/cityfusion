...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AccountReminding.eventDay'
        db.delete_column(u'accounts_accountreminding', 'eventDay_id')

        # Adding field 'AccountReminding.event_day'
        db.add_column(u'accounts_accountreminding', 'event_day',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['event.SingleEvent']),
                      keep_default=False)

        # Adding field 'AccountReminding.notification_type'
        db.add_column(u'accounts_accountreminding', 'notification_type',
                      self.gf('django.db.models.fields.CharField')(default='UNDEFINED', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AccountReminding.eventDay'
        db.add_column(u'accounts_accountreminding', 'eventDay',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['event.SingleEvent']),
                      keep_default=False)

        # Deleting field 'AccountReminding.event_day'
        db.delete_column(u'accounts_accountreminding', 'event_day_id')

        # Deleting field 'AccountReminding.notification_type'
        db.delete_column(u'accounts_accountreminding', 'notification_type')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
