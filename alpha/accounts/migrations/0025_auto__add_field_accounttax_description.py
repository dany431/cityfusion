...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountTax.description'
        db.add_column(u'accounts_accounttax', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountTax.description'
        db.delete_column(u'accounts_accounttax', 'description')
