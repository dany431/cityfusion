...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VenueAccountSocialLink'
        db.create_table(u'accounts_venueaccountsociallink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('venue_account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.VenueAccount'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'accounts', ['VenueAccountSocialLink'])


    def backwards(self, orm):
        # Deleting model 'VenueAccountSocialLink'
        db.delete_table(u'accounts_venueaccountsociallink')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'SINGLE'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
