...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.reminder_type_state'
        db.add_column(u'accounts_account', 'reminder_type_state', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Account.reminder_type_state'
        db.delete_column(u'accounts_account', 'reminder_type_state')
    ...
    models = {
        ...
        u'accounts.bonuscampaign': {
            'Meta': {'object_name': 'BonusCampaign'},
            'apply_to_old_accounts': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'accounts.venueaccountsociallink': {
            'Meta': {'object_name': 'VenueAccountSocialLink'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 2, 57, 41, 423077)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 2, 57, 41, 422521)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 2, 57, 40, 943108)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'SINGLE'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 11, 2, 57, 40, 943149)', 'auto_now': 'True', 'blank': 'True'}),
