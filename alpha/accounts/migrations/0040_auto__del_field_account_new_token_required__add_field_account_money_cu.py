...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.money_currency'
        db.add_column(u'accounts_account', 'money_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='CAD', max_length=3),
                      keep_default=False)

        # Adding field 'Account.money'
        db.add_column(u'accounts_account', 'money',
                      self.gf('djmoney.models.fields.MoneyField')(default='0.0', max_digits=10, decimal_places=2, default_currency='CAD'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.money_currency'
        db.delete_column(u'accounts_account', 'money_currency')

        # Deleting field 'Account.money'
        db.delete_column(u'accounts_account', 'money')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
