...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.reminder_each_day_from'
        db.add_column(u'accounts_account', 'reminder_each_day_from',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.reminder_each_day_at_time'
        db.add_column(u'accounts_account', 'reminder_each_day_at_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.reminder_each_day_from'
        db.delete_column(u'accounts_account', 'reminder_each_day_from')

        # Deleting field 'Account.reminder_each_day_at_time'
        db.delete_column(u'accounts_account', 'reminder_each_day_at_time')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'event_type': ('django.db.models.fields.CharField', [], {'default': "'SINGLE'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
