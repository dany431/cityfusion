...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.venue'
        db.delete_column(u'accounts_account', 'venue_id')


    def backwards(self, orm):
        # Adding field 'Account.venue'
        db.add_column(u'accounts_account', 'venue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Venue'], null=True, blank=True),
                      keep_default=False)
