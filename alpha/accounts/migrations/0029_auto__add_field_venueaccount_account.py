...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VenueAccount.account'
        db.add_column(u'accounts_venueaccount', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.Account']),
                      keep_default=False)

        # Removing M2M table for field accounts on 'VenueAccount'
        db.delete_table('accounts_venueaccount_accounts')


    def backwards(self, orm):
        # Deleting field 'VenueAccount.account'
        db.delete_column(u'accounts_venueaccount', 'account_id')

        # Adding M2M table for field accounts on 'VenueAccount'
        db.create_table(u'accounts_venueaccount_accounts', (
        ...
        db.create_unique(u'accounts_venueaccount_accounts', ['venueaccount_id', 'account_id'])
    ...
    models = {
        ...
        u'event.event': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
