...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.in_the_loop_days_before_event'
        db.add_column(u'accounts_account', 'in_the_loop_days_before_event',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.in_the_loop_hours_before_event'
        db.add_column(u'accounts_account', 'in_the_loop_hours_before_event',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.in_the_loop_on_week_day'
        db.add_column(u'accounts_account', 'in_the_loop_on_week_day',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.in_the_loop_on_week_day_at_time'
        db.add_column(u'accounts_account', 'in_the_loop_on_week_day_at_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.in_the_loop_with_website'
        db.add_column(u'accounts_account', 'in_the_loop_with_website',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Account.in_the_loop_with_email'
        db.add_column(u'accounts_account', 'in_the_loop_with_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Account.in_the_loop_with_sms'
        db.add_column(u'accounts_account', 'in_the_loop_with_sms',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Account.in_the_loop_email'
        db.add_column(u'accounts_account', 'in_the_loop_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.in_the_loop_phonenumber'
        db.add_column(u'accounts_account', 'in_the_loop_phonenumber',
                      self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.in_the_loop_days_before_event'
        db.delete_column(u'accounts_account', 'in_the_loop_days_before_event')

        # Deleting field 'Account.in_the_loop_hours_before_event'
        db.delete_column(u'accounts_account', 'in_the_loop_hours_before_event')

        # Deleting field 'Account.in_the_loop_on_week_day'
        db.delete_column(u'accounts_account', 'in_the_loop_on_week_day')

        # Deleting field 'Account.in_the_loop_on_week_day_at_time'
        db.delete_column(u'accounts_account', 'in_the_loop_on_week_day_at_time')

        # Deleting field 'Account.in_the_loop_with_website'
        db.delete_column(u'accounts_account', 'in_the_loop_with_website')

        # Deleting field 'Account.in_the_loop_with_email'
        db.delete_column(u'accounts_account', 'in_the_loop_with_email')

        # Deleting field 'Account.in_the_loop_with_sms'
        db.delete_column(u'accounts_account', 'in_the_loop_with_sms')

        # Deleting field 'Account.in_the_loop_email'
        db.delete_column(u'accounts_account', 'in_the_loop_email')

        # Deleting field 'Account.in_the_loop_phonenumber'
        db.delete_column(u'accounts_account', 'in_the_loop_phonenumber')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
