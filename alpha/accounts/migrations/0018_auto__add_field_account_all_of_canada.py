...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.all_of_canada'
        db.add_column(u'accounts_account', 'all_of_canada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field regions on 'Account'
        db.create_table(u'accounts_account_regions', (
        ...
        db.create_unique(u'accounts_account_regions', ['account_id', 'region_id'])

        # Adding M2M table for field cities on 'Account'
        db.create_table(u'accounts_account_cities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('account', models.ForeignKey(orm[u'accounts.account'], null=False)),
            ('city', models.ForeignKey(orm[u'cities.city'], null=False))
        ))
        db.create_unique(u'accounts_account_cities', ['account_id', 'city_id'])


    def backwards(self, orm):
        # Deleting field 'Account.all_of_canada'
        db.delete_column(u'accounts_account', 'all_of_canada')

        # Removing M2M table for field regions on 'Account'
        db.delete_table('accounts_account_regions')

        # Removing M2M table for field cities on 'Account'
        db.delete_table('accounts_account_cities')
    ...
    models = {
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
