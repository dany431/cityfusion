...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):        
        # Adding model 'BonusCampaign'
        db.create_table(u'accounts_bonuscampaign', (
        ...
        db.send_create_signal(u'accounts', ['BonusCampaign'])


    def backwards(self, orm):        
        # Deleting model 'BonusCampaign'
        db.delete_table(u'accounts_bonuscampaign')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 12, 35, 53, 574443)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 12, 35, 53, 573956)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 12, 35, 53, 65631)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 5, 12, 35, 53, 65677)', 'auto_now': 'True', 'blank': 'True'}),
