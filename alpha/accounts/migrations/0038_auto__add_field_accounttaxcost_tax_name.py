...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountTaxCost.tax_name'
        db.add_column(u'accounts_accounttaxcost', 'tax_name',
                      self.gf('django.db.models.fields.CharField')(default='Not set', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountTaxCost.tax_name'
        db.delete_column(u'accounts_accounttaxcost', 'tax_name')
