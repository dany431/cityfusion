...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        venue_types = ['Art Galleries & Museums & Attractions', 'Concerts & Conferences & Tradeshows',
                       'Festivals & Performing Arts & Film', 'Fundraising & Charity', 'Kids & Family',
                       'Literary & Books', 'Nightlife & Singles & Night Clubs', 'Politics & Activism',
                       'Religion & Spirituality', 'Restaurants & Food & Wine', 'Sales & Retail',
                       'Science & Technology', 'Sports & Fitness & Recreation', 'University & Alumni & Education']

        VenueType = orm['accounts.VenueType']
        VenueType.objects.all().delete()

        for type_name in venue_types:
            venue_type = VenueType(name=type_name)
            venue_type.save()
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 11, 10, 11, 317645)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 11, 10, 11, 316283)'}),
        ...
        u'event.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 11, 10, 10, 504691)', 'auto_now_add': 'True', 'blank': 'True'}),
            'cropping': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 11, 10, 10, 504778)', 'auto_now': 'True', 'blank': 'True'}),
