...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AccountTax.procents'
        db.delete_column(u'accounts_accounttax', 'procents')

        # Deleting field 'AccountTax.all_of_canada'
        db.delete_column(u'accounts_accounttax', 'all_of_canada')

        # Adding field 'AccountTax.tax'
        db.add_column(u'accounts_accounttax', 'tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AccountTax.procents'
        db.add_column(u'accounts_accounttax', 'procents',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'AccountTax.all_of_canada'
        db.add_column(u'accounts_accounttax', 'all_of_canada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AccountTax.tax'
        db.delete_column(u'accounts_accounttax', 'tax')
