...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Account.reminder_time_before_event'
        db.delete_column(u'accounts_account', 'reminder_time_before_event')

        # Adding field 'Account.reminder_active_type'
        db.add_column(u'accounts_account', 'reminder_active_type',
                      self.gf('django.db.models.fields.CharField')(default='HOURS', max_length=10),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Account.reminder_time_before_event'
        db.add_column(u'accounts_account', 'reminder_time_before_event',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Account.reminder_active_type'
        db.delete_column(u'accounts_account', 'reminder_active_type')
